...
function logout() {
    // Supprimez toutes les informations de session ici
    // Par exemple, si vous utilisez $_SESSION, vous pouvez appeler session_destroy() ou unset($_SESSION['collector_id'])
